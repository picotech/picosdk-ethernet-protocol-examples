...
namespace USBPT104Protocol
{
	...
	internal class UdpPt104 : UdpDevice, IDisposable
	{
		...
		public static UdpPt104 FindDevice()
		{
			...
			//
			// Broadcasting from IPAddress.Any would leave by one interface only, so a
			// PT-104 on any other subnet of a multi-homed host would never be found.
			// This overload of BroadCast sweeps every local interface in turn; use
			// FindDeviceOnAdapter to broadcast from one interface of your choosing.
